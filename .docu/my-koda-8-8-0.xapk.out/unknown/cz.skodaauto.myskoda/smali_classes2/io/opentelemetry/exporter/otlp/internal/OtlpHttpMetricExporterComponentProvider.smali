...
.method public create(Lio/opentelemetry/api/incubator/config/DeclarativeConfigProperties;)Lio/opentelemetry/sdk/metrics/export/MetricExporter;
    ...
    new-instance v2, Lex0/j;

    const/4 v0, 0x0

    invoke-direct {v2, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V
    ...
    invoke-direct {v3, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V

    .line 5
    new-instance v4, Lex0/k;

    const/4 v0, 0x0

    invoke-direct {v4, p0, v0}, Lex0/k;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V

    .line 6
    new-instance v5, Lex0/j;

    const/4 v0, 0x4

    invoke-direct {v5, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V
    ...
    invoke-direct {v6, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V
    ...
    invoke-direct {v7, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V

    .line 9
    new-instance v8, Lex0/k;

    const/4 v0, 0x1

    invoke-direct {v8, p0, v0}, Lex0/k;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V

    .line 10
    new-instance v9, Lex0/j;

    const/4 v0, 0x7

    invoke-direct {v9, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V
    ...
    invoke-direct {v10, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V
    ...
    invoke-direct {p1, p0, v0}, Lex0/j;-><init>(Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;I)V
    ...
    .line 17
    invoke-virtual {p0}, Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporterBuilder;->build()Lio/opentelemetry/exporter/otlp/http/metrics/OtlpHttpMetricExporter;
