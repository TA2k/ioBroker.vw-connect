.class public final Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics$State;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    .line 10
    sput-wide v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->NANOS_PER_S:D

    .line 11
    .line 12
    const-string v0, "http-client-metrics-state"
    ...
    .line 18
    sput-object v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->HTTP_CLIENT_REQUEST_METRICS_STATE:Lio/opentelemetry/context/ContextKey;

    .line 19
    .line 20
    const-class v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;
    ...
    .line 30
    sput-object v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->logger:Ljava/util/logging/Logger;
...
.method private constructor <init>(Lio/opentelemetry/api/metrics/Meter;)V
    ...
    .line 3
    .line 4
    const-string v0, "http.client.request.duration"
    ...
    .line 16
    const-string v0, "Duration of HTTP client requests."
    ...
    .line 28
    invoke-static {p1}, Lio/opentelemetry/instrumentation/api/semconv/http/HttpMetricsAdvice;->applyClientDurationAdvice(Lio/opentelemetry/api/metrics/DoubleHistogramBuilder;)V
    ...
    .line 35
    iput-object p1, p0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->duration:Lio/opentelemetry/api/metrics/DoubleHistogram;
...
.method public static synthetic a(Lio/opentelemetry/api/metrics/Meter;)Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;
    .locals 1

    .line 1
    new-instance v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;

    .line 2
    .line 3
    invoke-direct {v0, p0}, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;-><init>(Lio/opentelemetry/api/metrics/Meter;)V
...
.method public onEnd(Lio/opentelemetry/context/Context;Lio/opentelemetry/api/common/Attributes;J)V
    ...
    .line 1
    sget-object v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->HTTP_CLIENT_REQUEST_METRICS_STATE:Lio/opentelemetry/context/ContextKey;
    ...
    .line 7
    check-cast v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics$State;
    ...
    .line 10
    .line 11
    sget-object p0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->logger:Ljava/util/logging/Logger;
    ...
    .line 21
    :cond_0
    invoke-virtual {v0}, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics$State;->startAttributes()Lio/opentelemetry/api/common/Attributes;
    ...
    .line 37
    iget-object p0, p0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->duration:Lio/opentelemetry/api/metrics/DoubleHistogram;

    .line 38
    .line 39
    invoke-virtual {v0}, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics$State;->startTimeNanos()J
    ...
    .line 45
    sget-wide v0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->NANOS_PER_S:D
...
.method public onStart(Lio/opentelemetry/context/Context;Lio/opentelemetry/api/common/Attributes;J)Lio/opentelemetry/context/Context;
    ...
    .line 1
    sget-object p0, Lio/opentelemetry/instrumentation/api/semconv/http/HttpClientMetrics;->HTTP_CLIENT_REQUEST_METRICS_STATE:Lio/opentelemetry/context/ContextKey;

    .line 2
    .line 3
    new-instance v0, Lio/opentelemetry/instrumentation/api/semconv/http/AutoValue_HttpClientMetrics_State;

    .line 4
    .line 5
    invoke-direct {v0, p2, p3, p4}, Lio/opentelemetry/instrumentation/api/semconv/http/AutoValue_HttpClientMetrics_State;-><init>(Lio/opentelemetry/api/common/Attributes;J)V
