.class public final Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics$State;
    }
.end annotation
...
.field private final clientRequestSize:Lio/opentelemetry/api/metrics/LongHistogram;

.field private final clientResponseSize:Lio/opentelemetry/api/metrics/LongHistogram;
...
.method static constructor <clinit>()V
    ...
    .line 10
    sput-wide v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->NANOS_PER_MS:D
    ...
    .line 18
    sput-object v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->RPC_CLIENT_REQUEST_METRICS_STATE:Lio/opentelemetry/context/ContextKey;

    .line 19
    .line 20
    const-class v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;
    ...
    .line 30
    sput-object v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->logger:Ljava/util/logging/Logger;
...
.method private constructor <init>(Lio/opentelemetry/api/metrics/Meter;)V
    ...
    .line 10
    const-string v1, "The duration of an outbound RPC invocation."
    ...
    .line 22
    invoke-static {v0}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcMetricsAdvice;->applyClientDurationAdvice(Lio/opentelemetry/api/metrics/DoubleHistogramBuilder;)V
    ...
    .line 29
    iput-object v0, p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->clientDurationHistogram:Lio/opentelemetry/api/metrics/DoubleHistogram;

    .line 30
    .line 31
    const-string v0, "rpc.client.request.size"
    ...
    .line 53
    invoke-static {v0}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcMetricsAdvice;->applyClientRequestSizeAdvice(Lio/opentelemetry/api/metrics/LongHistogramBuilder;)V
    ...
    .line 60
    iput-object v0, p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->clientRequestSize:Lio/opentelemetry/api/metrics/LongHistogram;

    .line 61
    .line 62
    const-string v0, "rpc.client.response.size"
    ...
    .line 82
    invoke-static {p1}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcMetricsAdvice;->applyClientRequestSizeAdvice(Lio/opentelemetry/api/metrics/LongHistogramBuilder;)V
    ...
    .line 89
    iput-object p1, p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->clientResponseSize:Lio/opentelemetry/api/metrics/LongHistogram;
...
.method public static synthetic a(Lio/opentelemetry/api/metrics/Meter;)Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;
    .locals 1

    .line 1
    new-instance v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;

    .line 2
    .line 3
    invoke-direct {v0, p0}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;-><init>(Lio/opentelemetry/api/metrics/Meter;)V
...
.method public onEnd(Lio/opentelemetry/context/Context;Lio/opentelemetry/api/common/Attributes;J)V
    ...
    .line 1
    sget-object v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->RPC_CLIENT_REQUEST_METRICS_STATE:Lio/opentelemetry/context/ContextKey;
    ...
    .line 7
    check-cast v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics$State;
    ...
    .line 10
    .line 11
    sget-object p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->logger:Ljava/util/logging/Logger;
    ...
    .line 21
    :cond_0
    invoke-virtual {v0}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics$State;->startAttributes()Lio/opentelemetry/api/common/Attributes;
    ...
    .line 37
    iget-object v1, p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->clientDurationHistogram:Lio/opentelemetry/api/metrics/DoubleHistogram;

    .line 38
    .line 39
    invoke-virtual {v0}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics$State;->startTimeNanos()J
    ...
    .line 45
    sget-wide v2, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->NANOS_PER_MS:D
    ...
    .line 60
    .line 61
    iget-object p4, p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->clientRequestSize:Lio/opentelemetry/api/metrics/LongHistogram;
    ...
    .line 79
    .line 80
    iget-object p0, p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->clientResponseSize:Lio/opentelemetry/api/metrics/LongHistogram;
...
.method public onStart(Lio/opentelemetry/context/Context;Lio/opentelemetry/api/common/Attributes;J)Lio/opentelemetry/context/Context;
    ...
    .line 1
    sget-object p0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/RpcClientMetrics;->RPC_CLIENT_REQUEST_METRICS_STATE:Lio/opentelemetry/context/ContextKey;

    .line 2
    .line 3
    new-instance v0, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/AutoValue_RpcClientMetrics_State;

    .line 4
    .line 5
    invoke-direct {v0, p2, p3, p4}, Lio/opentelemetry/instrumentation/api/incubator/semconv/rpc/AutoValue_RpcClientMetrics_State;-><init>(Lio/opentelemetry/api/common/Attributes;J)V
